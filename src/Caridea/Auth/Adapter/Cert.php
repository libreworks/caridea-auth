...
class Cert extends AbstractAdapter
{
     ...
     * @param string $regex A regex to match a username inside the DN (if not specified, username is the entire DN). Must have one capture pattern.
     */
     ...
     * @throws \Caridea\Auth\Exception\MissingCredentials if no value was found in the SERVER field or the provided regular expression doesn't match
     */
