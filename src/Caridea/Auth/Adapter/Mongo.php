...
class Mongo extends AbstractAdapter
{
     ...
     * @param \Psr\Http\Message\ServerRequestInterface $request The Server Request message (to use for additional parameter binding)
     * @return \MongoCursor The results cursor
     */
    protected function getResults($username, \Psr\Http\Message\ServerRequestInterface $request)
    {
